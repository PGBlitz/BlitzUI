...
<table width="90%" border="1" height="42" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      ...
      <td width="33%" height="20" class="test" style="color: #FFFFFF; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><?php $output = shell_exec('cat /plexguide/pg.transport');
echo "<pre>$output</pre>";
?>
...
echo "<pre>$output</pre>" ?>
    ...
    <tr>
      <td height="20" bgcolor="#000000" style="color: #F7F6F6; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-weight: bold; font-size: medium; text-align: center;"><strong>Traefik</strong></td>
...
?>
      ...
      <td height="20" bgcolor="#000000" style="color: #F7F6F6; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-weight: bold; font-size: medium; text-align: center;"><strong>PG Shield</strong></td>
...
?>
      ...
      <td height="20" bgcolor="#000000" class="test" style="color: #FFFFFF; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: medium; text-align: center; font-weight: bold;">Port Guard</td>
      <td height="20" class="test" style="color: #FFFFFF; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: medium;"><span class="test" style="color: #FFFFFF; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: medium;">
        <?php $output = shell_exec('cat /var/plexguide/pg.ports');
echo "<pre>$output</pre>";
?>
      </span></td>
    </tr>
