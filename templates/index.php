...
<table width="90%" border="1" height="20" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
...
echo "<pre>$output</pre>";
?>
      <span style="text-align: center"></span><span style="text-align: center"></span></td>
      ...
      <td width="34%" height="20" class="test" style="color: #FFFFFF; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: medium;">
...
?>
      ...
      <td width="33%" height="20" class="test" style="color: #FFFFFF; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: medium;">
